...
const REPORT_V = 'layout-synced-hover'; // marker: bump to force a one-time report.html regen for ALL flights (v6.13.5: full-width charts, metrics+verdict moved below, synced crosshair + on-line dot across both charts, ref labels moved off the data, verdict contrast)
