...
const REPORT_V = 'fps-dots-all-visible-v6'; // marker: bump to force a one-time report.html regen for ALL flights (v6.19.5: FPS chart line reads from the smoothed series instead of reciprocated per-frame spikes)
