# Dean's MSFS Route Finder — v4.5.40
...
```
v4.5.40  Quick Launch companion apps — configure + launch from route detail
v4.5.40  Fix override panel collapsed by default, remove unused Steam exe field
